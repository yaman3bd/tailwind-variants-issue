...
const button = tv({
    ...
    base: [
        ...
        "[&.btn-is-fetching_[data-slot=icon]]:invisible [&.btn-is-fetching>[data-slot=children]]:invisible",
        "[&.btn-is-loading_[data-slot=icon]]:invisible [&.btn-is-loading>[data-slot=children]]:invisible"
    ],
    variants: {
        variant: {
            solid: "",
        ...
        isFetching: {
            true: "pointer-events-none btn-is-fetching"
        },
        isLoading: {
            true: "pointer-events-none btn-is-loading"
        },
        onlyIcon: {
            true: "gap-x-0"
        }
